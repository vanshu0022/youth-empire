        ...
        <div className="fixed inset-0 bg-black/50 z-20 md:hidden">
          <div className="bg-white h-4/5 w-full absolute bottom-0 rounded-t-xl p-6 flex flex-col">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <Link to="/highlights" className="flex flex-col items-center p-4 bg-gray-50 rounded-lg" onClick={toggleMenu}>
                <Trophy size={24} className="mb-2 text-student-purple" />
                <span className="text-sm text-center">Highlights</span>
              </Link>
              ...
              <Link to="/institutes" className="flex flex-col items-center p-4 bg-gray-50 rounded-lg" onClick={toggleMenu}>
                <Building size={24} className="mb-2 text-student-purple" />
                <span className="text-sm text-center">Institutes</span>
              </Link>
